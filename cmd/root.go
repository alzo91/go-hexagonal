/*
Copyright © 2024 Alisson Zotarelli
*/
package cmd
...
import (
	...
	dbInfra "github.com/alzo91/go-hexagonal/adapters/db"
...
var rootCmd = &cobra.Command{
	Use:   "go-hexagonal for product",
	Short: "This application is a tool to create a product using hexagonal architecture.",
	Long: `This application is a tool to create a product using hexagonal architecture. `,
